var strategy = {
    ...
    "results": [
			...
			"details_level_1":[
				{
					...
					"description" : "",
					"link" : "",
					"criteria": "Does1 the organisation base its digital strategy on overall strategic business objectives? Has it set KPIs for measuring success?",
				...
				},
				{
					...
					"description" : "",
					"link" : "",
					"criteria": "Does2 the organisation identify its varied audiences for digital communications? Does it address them differently?",
		...
		{
			"title" : "Website",
			"description" : "Looks at elements of digital strategy that apply to the organisation's website(s).",
			"link" : "",
			"score" : "0.0",
			"details_level_1":[
				{
